...
//  LGXLoginView
//
//  Created by 兴哥哥 on 2017/11/2.
//  Copyright © 2017年 lgx. All rights reserved.
//
...
#define defaultscale [UIScreen mainScreen].bounds.size.width/375
...
- (void)setupUI
{
    ...
    [_nameTextField mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.view.mas_left).offset(30);
         make.width.equalTo([NSNumber numberWithInt:kScreenW-60]);
        make.top.equalTo(self.contentScrollView.mas_top).equalTo([NSNumber numberWithInt:kForgetPwdBtnWidth]);
    ...
    [sepView1 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_nameTextField.mas_bottom).equalTo([NSNumber numberWithInt:1]);
    ...
    [_pwdTextField mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.equalTo([NSNumber numberWithInt:kScreenW-60]);
        make.height.equalTo([NSNumber numberWithInt:50]);
        make.top.equalTo(sepView1.mas_bottom).equalTo([NSNumber numberWithInt:20]);
    ...
    [sepView2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.view.mas_left).offset(30);
         make.width.equalTo([NSNumber numberWithInt:kScreenW-60]);
        make.height.equalTo([NSNumber numberWithInt:1]);
        make.top.equalTo(_pwdTextField.mas_bottom).equalTo([NSNumber numberWithInt:1]);
    ...
    [loginBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.equalTo([NSNumber numberWithInt:kScreenW-60]);
        make.height.equalTo([NSNumber numberWithInt:kTextFieldHeight]);
        make.left.equalTo(_pwdTextField.mas_left).offset(0);
        make.top.equalTo(sepView2.mas_bottom).equalTo([NSNumber numberWithInt:30]);
    ...
    [forgetPwdBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.equalTo( [NSNumber numberWithInt:kForgetPwdBtnWidth]);
        make.height.equalTo([NSNumber numberWithInt:kTextFieldHeight]);
        make.left.equalTo(_pwdTextField.mas_left).offset(0);
        make.top.equalTo(loginBtn.mas_bottom).equalTo([NSNumber numberWithInt:10]);
